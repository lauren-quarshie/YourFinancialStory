...
import { MobileWelcomeSlide } from './mobile-wrapped-slides/MobileWelcomeSlide';
import { MobileTotalSpendingSlide } from './mobile-wrapped-slides/MobileTotalSpendingSlide';
import { MobileTopCategoriesSlide } from './mobile-wrapped-slides/MobileTopCategoriesSlide';
import { MobileSavingsSlide } from './mobile-wrapped-slides/MobileSavingsSlide';
import { MobileSummarySlide } from './mobile-wrapped-slides/MobileSummarySlide';
// Import other mobile slides as they're created
...
const slides = [
  MobileWelcomeSlide,
  MobileTotalSpendingSlide,
  MobileTopCategoriesSlide,
  MobileSavingsSlide,
  TransactionsSlide,
